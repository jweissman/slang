...
describe("Slang", () => {
    ...
    it('hashes', () => {
        ...
        expect(slang.interpret(
            "y={subject:'world',...h}; y.greeting+' there '+y.subject"
        )).toEqual("hello there world")
        // expect(slang.interpret("h.greeting='hi';h.greeting")).toEqual("hi")
    })

    it("hash assignment", () => {
        expect(slang.interpret(
            "y.greeting = 'hi'; y.greeting+' '+y.subject"
        )).toEqual('hi world')
    })
    ...
    it('defs simple pseudo-objects', () => {
        expect(slang.interpret(
            "math = { times: (x) => (y) => x * y }; math.times(2)(2)"
        )).toEqual(4)
    })
    ...
    it('conditional logic', () => {
        ...
        expect(slang.interpret("a=2;b=3;a>b ?'bigger':'smaller'")).toEqual("smaller")
        expect(
