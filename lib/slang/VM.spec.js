...
describe("VM", () => {
    it("stores and retrieves values", () => {
        ...
        expect(()=>vm.lookupValue('b')).toThrow(new Error("No such variable or method b"));
    })
    ...
    it("defines and calls functions", () => {
        ...
        expect(
            vm.callAnonymousFunction(fnRef, [ new Int(1), new Int(2) ])
        ).toEqual(new Int(3))
        ...
        expect(
            vm.callAnonymousFunction(fnRef, [])
        ).toEqual(new Int(5))
    });
})